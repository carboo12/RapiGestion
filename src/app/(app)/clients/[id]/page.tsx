    ...
    if (id) {
      const fetchClient = async () => {
        ...
        if (clientSnap.exists()) {
          ...
          // TODO: Handle client not found, maybe redirect to a 404 page
      ...
      <Card>
        <CardHeader>
          ...
          <div className="flex items-center gap-4 text-sm pt-2">
            <span className="font-semibold text-green-600">Créditos Activos: 1</span>
            <span className="text-muted-foreground">Ciclos: 2</span>
          </div>
        </CardHeader>
